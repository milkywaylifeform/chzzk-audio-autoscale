...
> Chrome Web Store Developer Dashboard의 Store listing 폼에 그대로 복사하여 사용.
...
> "치지직 시청 시 채널마다 다른 음량과 갑작스러운 폭음을 자동으로 평탄화. BS.1770 LUFS 기준 인지 음량 정규화."

> "방송 진행자별로 들쭉날쭉한 치지직 음량을 실시간 평탄화. 갑작스런 비명·폭발음 억제 + 작은 목소리 자동 증폭."

---

## 상세 설명 (Detailed description)

**최대 16,000자, 마크다운 일부 지원(굵게·줄바꿈 정도)**
...
**Productivity** (생산성) 또는 **Tools** (도구) 추천. "Audio" 카테고리는 없음.

## 언어

**Korean (한국어)** 우선 등록. 영어 버전은 추후 추가.

## 권한 정당화 (Permissions justification)

콘솔 폼에서 각 권한마다 따로 입력. 다음 텍스트를 그대로 사용 가능:
